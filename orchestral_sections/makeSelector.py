...
'''C:/Users/{userName}/Documents/Steinberg/Cubase/User Presets/Project Logical Editor/Track Selection/'''
    ...
    for section, value in sections.items():
        ...
        for family, instruments in value.items():
            for instrument in instruments:
                ...
                shutil.copy(
                    'common/cubase-includes.xml', filePath)
